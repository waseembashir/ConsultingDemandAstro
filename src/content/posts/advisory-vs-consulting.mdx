...
This guide breaks down the real differences, shows how the Big Four treat each service line, and gives you a decision framework to pick the right model for your situation. For a broader look at what strategy consulting involves, our [strategy consulting 101](/blog/strategy-consulting-101/) guide is a good starting point.
...
Consulting works best when the question is "How do we solve this specific problem?" rather than "What should our strategy be?" If your challenge is less about advisory versus consulting and more about [strategy versus management consulting](/blog/strategy-vs-management-consulting/), that comparison has its own nuances worth exploring.
...
- **Hiring a consultant when you need an advisor.** If you don't know what the problem is yet, a consultant can't solve it. You'll burn through a project budget producing deliverables that miss the real issue. A related mistake is confusing consulting with [audit work](/blog/audit-vs-consulting/) — where the goals and independence requirements are fundamentally different.
